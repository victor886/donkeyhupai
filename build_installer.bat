rmdir /q /s %cd%\build
rmdir /q /s %cd%\dist
rmdir /q /s %cd%\沪牌助手-2017年3月版
del %cd%\bid.spec
del %cd%\沪牌助手-2017年3月版.rar
...
mkdir %cd%\dist\log
ren %cd%\dist\bid.exe 沪牌助手-2017年3月版.exe
xcopy %cd%\dist %cd%\沪牌助手-2017年3月版 /e /i /y
rar a -r 沪牌助手-2017年3月版.rar 沪牌助手-2017年3月版
pause